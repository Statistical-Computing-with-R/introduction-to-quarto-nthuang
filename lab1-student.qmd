...
```
## Tooth Growth T test analysis 
1. Since p-value is .06, it's greater than .05 meaning fail to reject the null hypothesis. 
2. There is not enough statistical evidence that then mean tooth lengths are significantly different.
3. The 95% confidence interval is (-.171, 7.571).
4. We are 95% confident that the true difference in mean tooth lengths lies between -.171 and 7.571
